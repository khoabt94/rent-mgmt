...
export function AccountPasswordPage() {
  ...
  return (
    <div className="p-4 bg-gray-100 min-h-screen">
      <h3 className="text-xl text-center">Đổi mật khẩu</h3>
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="flex flex-col gap-y-4 mt-4">
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormControl>
                  <PasswordInput placeholder="Mật khẩu cũ" {...field} className='text-base h-[50px]' />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormControl>
                  <PasswordInput placeholder="Mật khẩu mới" {...field} className='text-base h-[50px]' />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
          ...
          <Button type="submit" className='mt-5' disabled={form.formState.isSubmitting}>Đổi mật khẩu</Button>
        </form>
      </Form>
    </div >
